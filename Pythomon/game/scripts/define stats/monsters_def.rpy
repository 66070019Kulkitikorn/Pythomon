label load_monsters:
    ...
    $ mon1 = Monster("test1", 20, 15, 1.0, 50, 3, "1", "water", anim=slow_sway)#, skills=[arrowhail])
    $ mon2 = Monster("test2", 50, 20, 6.0, 50, 4, "2", "pound", anim=squeeze)#, skills=[mindfreeze])
    $ mon3 = Monster("test3", 30, 40, 3.0, 50, 5, "3", "tackle", anim=idle_shake)#, skills=[lifedrain])
